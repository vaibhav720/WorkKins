...
const { clientSignUp, clientLogin, clientLogout, getClientDetails, clientForgotPassword, editClientDetails, clientResetPassword } = require('../controller/clientController');
